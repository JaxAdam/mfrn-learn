...
export default class MenuItem extends Component {
    ...
    render() {
        ...
        !this.state.openEditForm ? (
            ...
            <span onClick={this.handleEditClick} className="btn edit" ><i className="fas fa-pen"/></span>
        <span onClick={this.handleDelete} className="btn delete"><i className="fas fa-trash"/></span>
        </div>
        </div>
    ) : (
